...
| :--- | :--- | :--- | :--- |
| `headerTitle` | `string` | `"Profile Settings"` | Header title. |
| `headerIcon` | `React.ReactNode` | `<User />` | Header icon. |
| `initialProfileData` | `Partial<ProfileData>` | `{}` | Initial profile data. |
...
| `avatarShape` | `string` | `"circle"` | Shape of the avatar. |
| `avatarSize` | `string` | `"3xl"` | Size of the avatar. |
| `inputVariant` | `string` | `"clean"` | Input variant. |
