...
import { QuizFormDemo, CompoundDemo } from '@site/src/components/Demo/QuizFormDemo';
...
| `cardVariant` | `'default' \| 'gradient' \| 'bordered'` | `'default'` | Visual style of the question card. |
