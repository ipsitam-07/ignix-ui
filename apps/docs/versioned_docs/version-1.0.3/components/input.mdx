...
| :--- | :--- | :--- | :--- |
| `placeholder` | `string` | - | The placeholder text for the input and label |
| `variant` | `string` | - | The animation variant to use (e.g., `clean`, `shimmer`, `neon`, `glassmorphism`, etc.) |
...
| `success` | `boolean` | - | Whether to show a success state |
| `icon` | `React.ElementType` | - | Optional leading icon to display |
| `showPasswordToggle` | `boolean` | `false` | Whether to show a toggle button for password visibility (if type is "password") |
